          ...
          {payments && payments?.map((pay, i) => (
            ...
            >
              ...
              <td className="py-3 px-3">
                <span
                  className={`px-3 py-1  rounded-full text-[6px] lg:text-[16px] font-semibold ${
              ...
              <td className="py-3 px-2 lg:px-6">
                {pay.paid_status === "pending" ? (
                  <button
                    ...
                    className="px-1 lg:px-3 py-2 text-[6px] lg:text-[16px] bg-indigo-600 text-white rounded-md font-semibold hover:bg-indigo-700 transition"
                  >
                    Accept Payment
                  </button>
                ) : (
